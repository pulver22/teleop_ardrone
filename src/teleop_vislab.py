...
if __name__=="__main__":
	...
	pub_empty_takeoff = rospy.Publisher('/quadrotor/ardrone/takeoff', Empty, queue_size=1)
	pub_empty_landing = rospy.Publisher('/quadrotor/ardrone/land', Empty,queue_size=1)
